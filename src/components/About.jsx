...
export default function About() {
  ...
  return (
    ...
    <img data-aos="fade-right"
        data-aos-delay="500"
        data-aos-duration="500" className="object-cover w-full lg:mx-6 lg:w-1/2 rounded-xl h-72 lg:h-96" src="https://www.lifewire.com/thmb/P0SUunr2Ti0qYZ8L3d71PP_JHvI=/1333x1000/smart/filters:no_upscale()/The-8-Best-Online-Coding-Courses-of-2021-77ff57d2460349c4b82842afc82d8e4b.jpg"alt=""/>
        <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
            
                
                <p data-aos="fade-right"
        data-aos-delay="1200"
        data-aos-duration="500" className="mt-3 text-sm text-gray-500 dark:text-dark-300 md:text-sm" style={{textAlign: 'justify', textIndent: '60px'}}>
                ...
                <p data-aos="fade-right" data-aos-delay="1200" data-aos-duration="500" className="mt-3 text-sm text-gray-500 dark:text-dark-300 md:text-sm" style={{textAlign: 'justify', textIndent: '60px'}}>I’m Justine, a Full-Stack Web Developer specializing in Web Development.
                </p>
                <p data-aos="fade-right"data-aos-delay="500" data-aos-duration="500" className="mt-3 text-sm text-gray-500 dark:text-dark-300 md:text-sm" style={{textAlign: 'justify', textIndent: '60px'}}>

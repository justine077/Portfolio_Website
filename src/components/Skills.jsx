...
<div name='skills' className='bg-light w-full text-gray-600'>
    ...
    <img data-aos='fade-right' className='w-20 mx-auto mt-5' src={HTML} alt="HTML icon" />
<p className='my-4'>HTML</p>
</div>       
    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#0a192f]'>
        <img data-aos='fade-right' className='w-20 mx-auto mt-5' src={CSS} alt="HTML icon" />
            <p className='my-4'>CSS</p>
                </div>
            <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#0a192f]'>
        <img data-aos='fade-right' className='w-20 mx-auto mt-5' src={JavaScript} alt="HTML icon" />
    <p className='my-4'>JAVASCRIPT</p>
</div>
    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#0a192f]'>
        <img data-aos='fade-right'  className='w-20 mx-auto mt-5' src={ReactImg} alt="HTML icon" />
            <p className='my-4'>REACT</p>
                </div>
            <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#0a192f]'>
        <img data-aos='fade-left' className='w-20 mx-auto mt-4' src={GitHub} alt="HTML icon" />
    <p className='my-4'>GITHUB</p>
</div>
    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#0a192f]'>
        <img data-aos='fade-left' className='w-20 mx-auto mt-4' src={Bootstrap} alt="HTML icon" />
            <p className='my-4'>BOOTSTRAP</p>
                </div>
            <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#0a192f]'>
        <img data-aos='fade-left' className='w-20 mx-auto mt-4' src={mysql} alt="HTML icon" />
    <p className='my-4'>MYSQL</p>
</div>
    <div  className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#0a192f]'>
        <img data-aos='fade-left' className='w-20 mx-auto mt-4' src={laravel} alt="HTML icon" />
